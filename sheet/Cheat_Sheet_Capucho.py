...
################################# RESISTENCIA AR #########################################
def forcaResAr(D, v, m): # D = coeficiente de re, v = velocidade, m = massa
...
def forcaResAr(C_res, A, v): # C_res = coeficiente de resistência do ar, A = área frontal, v = velocidade
    rho_ar = 1.225
    v_norm = np.linalg.norm(v)
